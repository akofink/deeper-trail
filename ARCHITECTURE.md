...
- `game/runtime/*` owns runtime-facing scene state types, derived vehicle stat helpers, deterministic run-layout/palette setup, expedition-flow bookkeeping, and run-objective UI/update/visual helpers for the current Pixi shell.
