...
- Synthesized approaches to the expedition goal now also alter the local run:
  ...
  - the run-end overlay now carries the decoded title, discovery beat, and completion line together, while the celebration card breaks out arrival, approach, run-assist, and afterglow consequences as separate readable lines,
