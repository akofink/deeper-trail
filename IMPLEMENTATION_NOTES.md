...
- Shared HUD header and module-label placement now belongs in `game/runtime/sceneHudView.ts` so panel text anchors and subsystem label grids stay consistent across scenes.
